      ...
      <div className="space-y-4">
        {quests.map((quest, i) => {
          ...
          return (
            <div
              key={i}
              className={`relative bg-[#080818] border-2 p-5 transition-all duration-300 hover:scale-[1.01] anim-fade-rise anim-fade-rise-d${Math.min(i + 1, 5)}
