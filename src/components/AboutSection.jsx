...
export default function AboutSection() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16 anim-fade-rise">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-12 lg:gap-20">
        ...
        {/* =========================================
            ...
            ========================================= */}
        <div className="flex flex-col items-center gap-6 w-full md:w-1/3 flex-shrink-0">
          ...
          <div className="flex gap-6 mt-4">
            {[
              ...
              { href: "mailto:abielqialani@gmail.com",                     icon: Mail,     color: "hover:text-pink-400" },
        ...
        {/* =========================================
            ...
            ========================================= */}
        <div className="w-full md:w-2/3 flex flex-col justify-center space-y-10 pt-4 md:pt-6">
          ...
          <div className="pt-6 border-t border-purple-900/30">
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6">
              {["Laravel", "React", "Flutter", "PHP", "MySQL", "Python", "Tailwind"].map((t) => (
                <span
                  key={t}
